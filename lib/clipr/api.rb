...
module Clipr
  ...
  module Api
    ...
    attach_function :DefineFunction,[:string, :int, :callback, :string], :int
    attach_function :DefineFunction2, [:string, :int, :callback, :string, :string], :int
    
    callback :env_callback, [:pointer], :int
    attach_function :EnvDefineFunction, [:pointer, :string, :int, :env_callback, :string], :int
    attach_function :EnvDefineFunction2, [:pointer, :string, :int, :env_callback, :string, :string], :int
